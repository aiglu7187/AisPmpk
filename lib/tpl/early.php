...
fulldata = [<?php echo $zaktype; ?>+";"+$("#zdate").val()+";"+$("#fio").val()+";"+$("#bdate").val()+";"+inv+";"+<?php echo $aoop; ?>+";"+$("#plusaoop").val()+";"+1+";"+1+";"+0+";"+0+";"+0+";"+$("#assist").val()+";"+1+";"+0+";"+1+";"+$("#stech").val()+";"+0+";"+0+";"+0+";"+1+";"+0+";"+$("#psywork").val()+";"+0+";"+$("#defwork").val()+";"+$("#socwork").val()+";"+inv+";"+13+";"+$("#psyname").val()+";"+$("#logname").val()+";"+$("#defname").val()+";"+$("#socname").val()+";"+"0"+";"+0+";"+$("#oonum").val()+";"+rdoop+";"+dolg+";"+$("#comtype").val()+";"+$("#roadmap").val()+";"+pol+";"+deviant+";"+bil+";"+$("#place").val()+";"+$("#family").val()+";"+$("#initd").val()+";"+$("#othersign").val()];
...
$.ajax({   
    type: "POST",
    data:{"zaktype":<?php echo $zaktype; ?>, "aoop":<?php echo $aoop; ?>, "plusaoop":$("#plusaoop").val() <?php if ($mainedit==1) { echo ', "editable":1, "addpsy":addpsy, "addlog":addlog, "adddef":adddef, "addsoc":addsoc'; } ?>}, 
    url: "lib/dopaoop.php",
    dataType: "html",            
    success: function(response){                    
        $("#doppsy").html(response);
