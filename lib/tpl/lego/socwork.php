...
<div class="field">
      ...
      <div class="ui selection multiple search  dropdown fluid">
          <input type="hidden"  id="socwork" name="socwork" >
    ...
    $result = mysqli_query($link, "SELECT fb_worksoc, id_edulevelvar, name, tipname FROM lib_worksoc WHERE status=1 AND id_type_z=$zaktype") or die("ошибка в выборке ассистента");
