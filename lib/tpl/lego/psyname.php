...
<label>Педагоги-психологи:</label>
    <div class="ui fluid  search selection dropdown">
      <input type="hidden" name="psyname" id="psyname" <?php if($mainedit==1) {echo 'value="'.$mrow[32].'"'; } ?>>
...
<div class="menu">
 ...
 <?php 
    $result = mysqli_query($link, "SELECT id_users, first_name, second_name, third_name FROM users WHERE acc_status=1 AND profession=1 and role=10 ORDER BY second_name") or die("ошибка в выборке ассистента");
